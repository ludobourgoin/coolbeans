...
// jamais sa cause.
//
// Et l'oubli ne se voit pas en développement : en local il n'y a qu'un hôte,
// donc aucune réécriture, donc la page répond. Il n'apparaît que sur my.*,
// où la page part vers la connexion sans un mot. C'est ce qui lui vaut un
// test plutôt qu'un rappel dans un commentaire.
//
