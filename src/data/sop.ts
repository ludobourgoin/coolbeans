...
export const etapes: Etape[] = [
  ...
  },
  {
    ...
    qui: "coolbeans",
    outils: [
      "src/content/temoignage/<client>/<projet>-<id>.yaml",
      "Boîte mail",
      "Portail client",
      "skill livraison-client",
    ],
    faire: [
      "Amorcer src/content/projets/<slug>.md en brouillon, avec du faux texte dans le bloc de citation.",
      "Composer la page de témoignage : les trois questions, la photo, la relecture du cas client.",
      "Écrire le mail de livraison : livrables, garantie avec sa date de fin explicite, liens doc et portail, lien de la page de témoignage.",
  ...
  },
  {
    ...
    faire: [
      ...
      "Remplacer le faux texte par le témoignage, mot pour mot, sans réécrire.",
      "Intégrer les retours du client : il a le dernier mot sur ce qui parle de lui.",
      "Relancer avec le lien de la page de témoignage si rien n'est arrivé.",
      "Publier en passant brouillon: false, ajouter l'entrée à src/data/portfolio.ts, mettre à jour sitemap et métadonnées.",
      "Passer formulaire: false sur la page de témoignage : elle devient une trace.",
    ],
    sortie: "Cas client en ligne.",
    suivants: [{ vers: "S18b", si: "le cas client est publié" }],
    note: "L'autorisation a été donnée au cadrage puis actée au devis par une ligne de remise, et la relecture a eu lieu sur la page de témoignage de J+0. Ici, on finit et on publie. Le faux texte laissé dans le bloc de citation n'est pas un pis-aller : un client qui voit du latin dans un encadré à son nom a envie de le remplacer, et c'est la relance qui marche.",
  },
  {
    id: "S18b",
    phase: "apres-vente",
