...
export const colonnesCrm: ColonneCrm[] = [
  ...
  { nom: "🎯 À chiffrer", type: "started", role: "Besoin cadré, proposition à produire." },
  {
    ...
    type: "started",
    role: "La proposition commerciale est partie. Couvre aussi les relances et la négociation.",
  },
  {
    nom: "✍️ Proposition validée",
    type: "started",
    role: "Le lead a dit oui, l'argent n'est pas arrivé. Devis Tiime et facture d'acompte à émettre, puis l'envoi des trois documents.",
  },
  {
    nom: "🏆 Signée",
    type: "started",
...
export const etapes: Etape[] = [
  ...
  // ---- Avant-vente ---------------------------------------------------------
  {
    ...
    faire: [
      ...
      "Trancher entre les deux voies : lien de réservation, ou document de cadrage (S1b). Le cadrage quand le besoin est flou, que plusieurs solutions techniques ont des coûts très différents, ou qu'aucun budget n'a été évoqué.",
      "Envoyer le lien de réservation Notion Calendar, ou le document de cadrage.",
    ],
    sortie: "Lien de réservation envoyé, ou document de cadrage envoyé.",
    echeance:
    ...
    suivants: [
      ...
      { vers: "S1b", si: "le besoin est flou, ou aucun budget n'a été évoqué" },
  ...
  },
  {
    id: "S1b",
    phase: "avant-vente",
    titre: "Cadrage envoyé",
    colonneCrm: "👋 Contacté",
    declencheur:
      "Le besoin est trop flou pour être chiffré, plusieurs solutions techniques s'opposent avec des coûts sans commune mesure, ou aucun budget n'a été évoqué.",
    qui: "les-deux",
    outils: ["Skill proposition-commerciale (mode cadrage)", "Linear — 🎯 CRM"],
    faire: [
      "Composer le document avec la skill, puis le relire entièrement. Rien ne part sans relecture.",
      "Vérifier que le tableau comparatif porte bien une ligne de coût par solution, et que la solution recommandée est désignée.",
      "Vérifier que les questions qui déplacent le chiffrage portent decisif: true.",
      "Publier en staging, vérifier la page, puis publier en production sur ordre explicite.",
      "Envoyer le lien à la main, jamais depuis Claude.",
      "Dater une relance à J+5 : sans réponse, on repasse au rendez-vous ou on classe.",
    ],
    sortie:
      "Réponses reçues par mail, avec les trois questions décisives en tête. Le lead a vu les ordres de grandeur et a dit son budget, ou a dit qu'il ne le connaissait pas.",
    echeance: "« Relancer le cadrage », datée à J+5.",
    suivants: [
      { vers: "S4", si: "les réponses suffisent à chiffrer" },
      { vers: "S2", si: "les réponses appellent une conversation" },
      { vers: "S20", si: "le budget n'est pas là mais le projet reste vivant" },
      { vers: "S21", si: "le budget ou le besoin sont hors cible" },
    ],
    note: "Cette étape remplace un rendez-vous, elle ne s'y ajoute pas. Elle a un coût : demander dix minutes de travail à quelqu'un avant de lui avoir rien donné. Elle ne s'utilise donc pas partout — voir « Quand ne pas l'envoyer » dans la doc de vente. Sa valeur est de faire dire un budget par écrit, avant d'avoir passé une heure au téléphone.",
  },
  {
    id: "S2",
    phase: "avant-vente",
  ...
  },
  {
    ...
    colonneCrm: "📝 Proposition envoyée",
  ...
  },
  {
    ...
    colonneCrm: "📝 Proposition envoyée",
    declencheur:
      "Le client répond par une question ou une objection — réponse « question » sur la page de la proposition.",
    qui: "les-deux",
    outils: ["Page /devis/<slug>", "src/content/devis/<slug>.yaml"],
    faire: [
      "Répondre à l'objection.",
      "Réviser la proposition si besoin, en publiant une nouvelle version du YAML.",
      "Ne jamais baisser le prix sans retirer du périmètre.",
    ],
    sortie: "Nouvelle version envoyée, ou accord.",
    suivants: [
      { vers: "S7", si: "le client valide la proposition" },
  ...
  // ---- Signature -----------------------------------------------------------
  {
    ...
    colonneCrm: "✍️ Proposition validée",
    declencheur:
      "Le client valide sur la page de la proposition, ce qui transmet raison sociale, SIREN, adresse, TVA et l'acceptation des CGV.",
    qui: "client",
    outils: ["Page /devis/<slug>", "Boîte mail", "Linear — 🎯 CRM"],
    faire: [
      ...
      "Vérifier que l'affaire est bien passée en ✍️ Proposition validée et que la sous-tâche de facturation est née sous elle.",
    ],
    sortie: "Commande ferme. Aucun document comptable n'existe encore.",
    suivants: [{ vers: "S8", si: "la commande est ferme" }],
    note: "Le passage de colonne et la création de la sous-tâche sont automatiques : c'est la validation du formulaire qui les déclenche. Une commande ferme n'est pas une affaire signée — il manque l'argent.",
  },
  {
    id: "S8",
    phase: "signature",
    titre: "Devis, acompte et envoi des trois documents",
    colonneCrm: "✍️ Proposition validée",
    declencheur: "La commande est ferme.",
    qui: "coolbeans",
    outils: ["Tiime", "Boîte mail"],
    faire: [
      ...
      "Saisir les échéances suivantes aux dates de la proposition.",
      "Envoyer un seul mail au client avec les trois documents : la proposition commerciale validée, le devis et la facture d'acompte.",
    ],
    sortie: "Les trois documents sont chez le client, échéancier saisi dans Tiime.",
    echeance: "« Vérifier l'encaissement de l'acompte », datée à l'échéance de la facture.",
    suivants: [{ vers: "S9", si: "les trois documents sont envoyés" }],
    note: "L'ordre n'est pas négociable : rien ne s'émet dans Tiime avant que la proposition soit validée, et les trois documents partent ensemble, dans un seul mail. Un devis Tiime émis sur une proposition non validée devra être annulé. Rien ne démarre avant encaissement.",
  },
  {
    id: "S9",
    phase: "signature",
  ...
  },
  {
    ...
    qui: "coolbeans",
    outils: ["Boîte mail", "Portail client", "skill livraison-client"],
    faire: [
      "Récapituler les livrables.",
      "Rappeler la garantie de 30 jours, avec sa date de fin explicite.",
      "Poser les trois questions du témoignage : « qu'est-ce qui posait problème avant ? », « comment ça s'est passé ? », « à qui tu le recommanderais ? ».",
      "Proposer l'alternative : le même retour en recommandation LinkedIn, que Coolbeans reprend ensuite sur le site.",
      "Demander la photo de profil, en donnant la sienne sur LinkedIn comme exemple de cadrage.",
      "Donner les liens vers la doc et le portail.",
      "Amorcer src/content/projets/<slug>.md en brouillon, pendant que le projet est frais.",
      "Dater les deux sous-issues d'après-vente : J+30 et J+90.",
    ],
    sortie: "Projet livré, garantie ouverte, témoignage demandé au bon moment.",
    suivants: [{ vers: "S16", si: "le mail est parti" }],
    note: "La deuxième question ne demande pas « ce qui a changé » : le jour de la livraison, le client n'a aucun résultat et répondrait au jugé. L'émotion se récolte ici, la preuve à J+90 (S18b). Détail des trois mails dans la skill livraison-client.",
  },
  {
    id: "S16",
    phase: "production",
  ...
  },
  {
    id: "S18",
    phase: "apres-vente",
    titre: "Cas client validé et publié",
    declencheur: "La garantie est close. Même mail que S17.",
    qui: "les-deux",
    outils: [
      "src/content/projets/<slug>.md",
      "src/data/portfolio.ts",
      "skill livraison-client",
    ],
    faire: [
      "Finir la page amorcée à la livraison : contexte, difficulté, solution, résultat.",
      "Y intégrer le témoignage, ou du faux texte assumé s'il n'est pas arrivé.",
      "Envoyer le lien /projets/<slug> pour validation, en disant qu'elle n'est ni publiée ni indexée.",
      "Demander l'avis public dans le même mail, avec son lien direct.",
      "Intégrer les retours du client : il a le dernier mot sur ce qui parle de lui.",
      "Publier en passant brouillon: false, ajouter l'entrée à src/data/portfolio.ts, mettre à jour sitemap et métadonnées.",
    ],
    sortie: "Cas client en ligne.",
    suivants: [{ vers: "S18b", si: "le cas client est publié" }],
    note: "L'autorisation a été donnée au cadrage puis actée au devis par une ligne de remise. Ici, seul le contenu se valide. Le faux texte dans le bloc de citation n'est pas un pis-aller : un client qui voit du latin dans un encadré à son nom a envie de le remplacer, et c'est la relance qui marche.",
  },
  {
    id: "S18b",
    phase: "apres-vente",
    titre: "Résultats à trois mois",
    declencheur: "Trois mois après la mise en ligne.",
    qui: "les-deux",
    outils: ["Boîte mail", "src/content/projets/<slug>.md"],
    faire: [
      "Donner ce qu'on observe de son côté avant de demander quoi que ce soit.",
      "Poser les deux questions : « qu'est-ce qui a changé depuis, concrètement ? » et « des chiffres que je peux citer ? », avec des exemples pris dans son métier.",
      "Compléter la section « Et depuis » du cas client.",
      "Remplacer la citation à chaud par celle qui porte un résultat, quand elle arrive.",
      "Demander la mise en relation, en une ligne, sans insister.",
    ],
    sortie: "Le cas client dit ce que le projet a produit, pas seulement ce qui a été construit.",
    echeance: "« J+90 : résultats et cas client », du projet client, datée dès la livraison.",
    suivants: [{ vers: "S19", si: "les résultats sont intégrés" }],
    note: "C'est le moment où la mise en relation se demande : elle rapporte plus que tout le reste, et c'est la seule demande qui suppose que le client a vécu le résultat. Posée à la livraison, elle lui fait recommander quelque chose qu'il n'a pas encore éprouvé.",
  },
  {
    id: "S19",
    phase: "apres-vente",
    titre: "Suivi",
    declencheur: "Le cas client est complet, le client entre en vie courante.",
    qui: "coolbeans",
